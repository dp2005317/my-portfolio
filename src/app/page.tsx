    ...
    <section id="contact" className="py-32 relative overflow-hidden bg-[var(--light)] neo-border border-l-0 border-r-0 border-b-0">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <a href="#" className="bg-[var(--light)] p-4 neo-btn hover:bg-[#E1306C] hover:text-white transition-colors group">
            <Instagram size={32} className="group-hover:scale-110 transition-transform" />
          </a>
          <a href="#" className="bg-[var(--light)] p-4 neo-btn hover:bg-[#25D366] hover:text-white transition-colors font-bold font-display text-2xl flex items-center px-8 uppercase tracking-wide">
            WhatsApp
          </a>
        </div>
      </div>
